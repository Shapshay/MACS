...
function getBaseURL($chpuURL) {
	...
	if(isset($chpuURL[2])){
		...
		elseif(strpos($chpuURL[1],"item")>0||strpos($chpuURL[1],"c_id")>0||strpos($chpuURL[1],"count")>0||
			strpos($chpuURL[1],"add_cost")>0||strpos($chpuURL[1],"polis_view")>0||strpos($chpuURL[1],"act")>0){
